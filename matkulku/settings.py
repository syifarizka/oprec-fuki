"""
Django settings for matkulku project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'mzvu#sep&(am^37b2_57^v#lrv!=56w%(%xwpyn9h_%&brqj4k')
...
WSGI_APPLICATION = 'matkulku.wsgi.application'
